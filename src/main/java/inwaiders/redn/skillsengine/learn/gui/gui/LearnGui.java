...
import inwaiders.redn.skillsengine.learn.LearnPointsClient;
import inwaiders.redn.skillsengine.learn.PlayerLearnPointManagerClient;
...
public class LearnGui extends GuiScreen
{
	...
	{
		LearnPointsClient l = PlayerLearnPointManagerClient.instance.get(mc.thePlayer); 
